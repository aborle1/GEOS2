...
#ifndef PIO_TKR 
#ifndef ESMF_NO_INTEGER_1_BYTE 
 module procedure ESMF_ArrayCreateFromPtrArb1DI1 
 module procedure ESMF_ArrayCreateFromPtrArb2DI1 
 module procedure ESMF_ArrayCreateFromPtrArb3DI1 
 module procedure ESMF_ArrayCreateFromPtrArb4DI1 
#ifndef ESMF_NO_GREATER_THAN_4D 
 module procedure ESMF_ArrayCreateFromPtrArb5DI1 
 module procedure ESMF_ArrayCreateFromPtrArb6DI1 
 module procedure ESMF_ArrayCreateFromPtrArb7DI1 
#endif 
#endif 
#ifndef ESMF_NO_INTEGER_2_BYTE 
 module procedure ESMF_ArrayCreateFromPtrArb1DI2 
 module procedure ESMF_ArrayCreateFromPtrArb2DI2 
 module procedure ESMF_ArrayCreateFromPtrArb3DI2 
 module procedure ESMF_ArrayCreateFromPtrArb4DI2 
#ifndef ESMF_NO_GREATER_THAN_4D 
 module procedure ESMF_ArrayCreateFromPtrArb5DI2 
 module procedure ESMF_ArrayCreateFromPtrArb6DI2 
 module procedure ESMF_ArrayCreateFromPtrArb7DI2 
#endif 
#endif 
#endif 
 module procedure ESMF_ArrayCreateFromPtrArb1DI4 
#ifndef PIO_TKR 
 module procedure ESMF_ArrayCreateFromPtrArb1DI8 
#endif 
 module procedure ESMF_ArrayCreateFromPtrArb1DR4 
 module procedure ESMF_ArrayCreateFromPtrArb1DR8 
 module procedure ESMF_ArrayCreateFromPtrArb2DI4 
#ifndef PIO_TKR 
 module procedure ESMF_ArrayCreateFromPtrArb2DI8 
#endif 
 module procedure ESMF_ArrayCreateFromPtrArb2DR4 
 module procedure ESMF_ArrayCreateFromPtrArb2DR8 
 module procedure ESMF_ArrayCreateFromPtrArb3DI4 
#ifndef PIO_TKR 
 module procedure ESMF_ArrayCreateFromPtrArb3DI8 
#endif 
 module procedure ESMF_ArrayCreateFromPtrArb3DR4 
 module procedure ESMF_ArrayCreateFromPtrArb3DR8 
 module procedure ESMF_ArrayCreateFromPtrArb4DI4 
#ifndef PIO_TKR 
 module procedure ESMF_ArrayCreateFromPtrArb4DI8 
#endif 
 module procedure ESMF_ArrayCreateFromPtrArb4DR4 
 module procedure ESMF_ArrayCreateFromPtrArb4DR8 
#ifndef ESMF_NO_GREATER_THAN_4D 
 module procedure ESMF_ArrayCreateFromPtrArb5DI4 
#ifndef PIO_TKR 
 module procedure ESMF_ArrayCreateFromPtrArb5DI8 
#endif 
 module procedure ESMF_ArrayCreateFromPtrArb5DR4 
 module procedure ESMF_ArrayCreateFromPtrArb5DR8 
#ifndef PIO_TKR 
 module procedure ESMF_ArrayCreateFromPtrArb6DI4 
 module procedure ESMF_ArrayCreateFromPtrArb6DI8 
 module procedure ESMF_ArrayCreateFromPtrArb6DR4 
 module procedure ESMF_ArrayCreateFromPtrArb6DR8 
 module procedure ESMF_ArrayCreateFromPtrArb7DI4 
 module procedure ESMF_ArrayCreateFromPtrArb7DI8 
 module procedure ESMF_ArrayCreateFromPtrArb7DR4 
 module procedure ESMF_ArrayCreateFromPtrArb7DR8 
#endif 
#endif 
! < end macro - do not edit directly > 
!------------------------------------------------------------------------------ 
...
#define ESMF_METHOD "ESMF_ArrayCreateFromPtr" 
 function ESMF_ArrayCreateFromPt
loSeqIndexList, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 name, rc) 

 type(ESMF_Array) :: ESMF_ArrayCreateFromPtrArb7Dr8 
 ...
 ! Call into conventional interface to create the Array object 
 ESMF_ArrayCreateFromPtrArb7Dr8 = & 
 ESMF_ArrayCreate(distgrid, farrayPtr, datacopyflag=datacopyflag, & 
 distgridToArrayMap=distgridToArrayMap, totalUWidth=(/localHaloCount/), & 
 name=name, rc=localrc) 
 if (ESMF_LogFoundError(localrc, ESMF_ERR_PASSTHRU, & 
 ...
 end function ESMF_ArrayCreateFromPtrArb7Dr8 
!---------------------------------------------------------------------------- 
...
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape1Di1(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape2Di1(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape3Di1(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape4Di1(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape5Di1(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape6Di1(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape7Di1(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape1Di2(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape2Di2(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape3Di2(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape4Di2(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape5Di2(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape6Di2(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape7Di2(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape1Di4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape1Di8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape1Dr4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape1Dr8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape2Di4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape2Di8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape2Dr4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape2Dr8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape3Di4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape3Di8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape3Dr4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape3Dr8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape4Di4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape4Di8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape4Dr4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape4Dr8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape5Di4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape5Di8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape5Dr4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape5Dr8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape6Di4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape6Di8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape6Dr4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape6Dr8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape7Di4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape7Di8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape7Dr4(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
#undef ESMF_METHOD 
#define ESMF_METHOD "ESMF_ArrayCreateAssmdShape" 
 function ESMF_ArrayCreateAssmdShape7Dr8(distgrid, farray, & 
 indexflag, keywordEnforcer, datacopyflag, distgridToArrayMap, & 
 computationalEdgeLWidth, computationalEdgeUWidth, & 
 computationalLWidth, computationalUWidth, totalLWidth, & 
 totalUWidth, undistLBound, undistUBound, name, rc) 
...
! objects according to distgrid. Besides {\tt localarrayList} each PET must issue
...
! !INTERFACE:
  ...
  function ESMF_ArrayCreateLocalArrayArb(distgrid, localarrayList, &
    haloSeqIndexList, keywordEnforcer, datacopyflag, distgridToArrayMap, undistLBound, &
...
!------------------------------------------------------------------------------
    ...
    localHaloCount = size(haloSeqIndexList)
    ! Call into conventional interface to create the Array object
    ESMF_ArrayCreateLocalArrayArb = ESMF_ArrayCreate(distgrid, localarrayList, &
      datacopyflag=datacopyflag, distgridToArrayMap=distgridToArrayMap, &
...
! !INTERFACE:
  ! Private name; call using ESMF_ArrayCreate()
  function ESMF_ArrayCreateAllocate(distgrid, typekind, keywordEnforcer, indexflag, &
...
! !INTERFACE:
  ...
  function ESMF_ArrayCreateAllocateArb(distgrid, typekind, &
    haloSeqIndexList, keywordEnforcer, distgridToArrayMap, &
    undistLBound, undistUBound, name, rc)
!
! !ARGUMENTS:
       type(ESMF_DistGrid), intent(in) :: distgrid
...
!------------------------------------------------------------------------------
    ...
    ESMF_ArrayCreateAllocateArb = ESMF_ArrayCreate(distgrid, arrayspec, &
      haloSeqIndexList, distgridToArrayMap=distgridToArrayMap, &
      undistLBound=undistLBound, undistUBound=undistUBound, &
      name=name, rc=localrc)
    if (ESMF_LogFoundError(localrc, ESMF_ERR_PASSTHRU, &
      ESMF_CONTEXT, rcToReturn=rc)) return
...
! !INTERFACE:
  ! Private name; call using ESMF_ArrayCreate()
  function ESMF_ArrayCreateAllocateAS(distgrid, arrayspec, keywordEnforcer, indexflag, &
    distgridToArrayMap, computationalEdgeLWidth, computationalEdgeUWidth, &
    computationalLWidth, computationalUWidth, totalLWidth, totalUWidth, &
    undistLBound, undistUBound, name, rc)
!
...
!------------------------------------------------------------------------------
    ...
    ESMF_ArrayCreateAllocateASArb = ESMF_ArrayCreate(distgrid, arrayspec, &
      distgridToArrayMap=distgridToArrayMap, totalUWidth=(/localHaloCount/), &
      undistLBound=undistLBound, undistUBound=undistUBound, name=name, &
      rc=localrc)
    if (ESMF_LogFoundError(localrc, ESMF_ERR_PASSTHRU, &
      ESMF_CONTEXT, rcToReturn=rc)) return
    ! Set the arbitrary sequence indices in the Array halo rim
...
! !INTERFACE:
  ! Private name; call using ESMF_ArrayCreate()
  function ESMF_ArrayCreateCopy(array, keywordEnforcer, rc)
!
! !ARGUMENTS:
...
! !INTERFACE:
  subroutine ESMF_ArrayDestroy(array, keywordEnforcer, rc)
!
! !ARGUMENTS:
...
! -------------------------- ESMF-internal method -------------------------------
#undef ESMF_METHOD
#define ESMF_METHOD "ESMF_ArraySetPLocalDeInternal()"
!BOPI
! !IROUTINE: ESMF_ArraySetPLocalDeInternal - Set Array properties
!
! !INTERFACE:
  subroutine ESMF_ArraySetPLocalDeInternal(array, localDe, rimSeqIndex, rc)
!
! !ARGUMENTS:
    type(ESMF_Array), intent(inout) :: array
...
!------------------------------------------------------------------------------
    integer :: localrc ! local return code
    type(ESMF_InterfaceInt) :: rimSeqIndexArg ! helper variable
    ! initialize return code; assume routine not implemented
    localrc = ESMF_RC_NOT_IMPL
    if (present(rc)) rc = ESMF_RC_NOT_IMPL
    ! Check init status of arguments
    ...
    ! Deal with (optional) array arguments
    rimSeqIndexArg = ESMF_InterfaceIntCreate(farray1D=rimSeqIndex, rc=localrc)
    if (ESMF_LogFoundError(localrc, ESMF_ERR_PASSTHRU, &
      ESMF_CONTEXT, rcToReturn=rc)) return
    ! Call into the C++ interface, which will sort out optional arguments
    ...
    if (ESMF_LogFoundError(localrc, ESMF_ERR_PASSTHRU, &
      ESMF_CONTEXT, rcToReturn=rc)) return
    ! Garbage collection
    call ESMF_InterfaceIntDestroy(rimSeqIndexArg, rc=localrc)
    if (ESMF_LogFoundError(localrc, ESMF_ERR_PASSTHRU, &
      ESMF_CONTEXT, rcToReturn=rc)) return
    ! return successfully
    if (present(rc)) rc = ESMF_SUCCESS
  end subroutine ESMF_ArraySetPLocalDeInternal
!------------------------------------------------------------------------------
! -------------------------- ESMF-public method -------------------------------
#undef ESMF_METHOD
...
! !INTERFACE:
  ! Private name; call using ESMF_ArrayCreate()
  function ESMF_ArrayCreateFromLA(localarray, haloWidth, deCount, rootPET, rc)
!
! !ARGUMENTS:
    type(ESMF_LocalArray), intent(in), optional :: localarray
...
! {\tt rootPET}'s {\tt localarray} will be scattered across the newly
! created {\tt ESMF\_Array} object before returning. Only
! {\tt rootPET} must provide a (valid) {\tt localarray} argument.
! \item[{[haloWidth]}]
...
! \item[rootPET]
! PET that holds the valid data in {\tt localarray}.
! \item[{[rc]}]
! Return code; equals {\tt ESMF\_SUCCESS} if there are no errors.
! \end{description}
!
...
!------------------------------------------------------------------------------
    ...
    localrc = ESMF_RC_NOT_IMPL
    ! Check init status of arguments
    ESMF_INIT_CHECK_DEEP_SHORT(ESMF_LocalArrayGetInit, localarray, rc)
    ...
    if (present(haloWidth)) then
      ...
      if (localPET==rootPET) then
        call ESMF_LocalArrayGet(localarray, rank=laRank, rc=localrc)
        if (len_haloWidth/=laRank) then
          if (ESMF_LogFoundError(ESMF_RC_ARG_VALUE, &
            msg="size of haloWidth array does not match rank of LocalArray", &
            ESMF_CONTEXT, rcToReturn=rc)) return
        endif
      endif
    else
    ...
    ! Call into the C++ interface, which will sort out optional arguments.
! call c_ESMC_ArrayCreate(array, localarray, opt_haloWidth, len_haloWidth, &
