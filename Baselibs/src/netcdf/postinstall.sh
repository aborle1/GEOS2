...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-ljpeg -lmfhdf -ldf -lhdf5_hl -lhdf5 -ldl -lm -L/home/aborle1/Baselibs/powerpc64le-unknown-linux-gnu/gfortran_5.4.0-openmpi_1.10.2/Linux/lib -lmfhdf -ldf -lsz -ljpeg  -L/home/aborle1/Baselibs/powerpc64le-unknown-linux-gnu/gfortran_5.4.0-openmpi_1.10.2/Linux/lib -lcurl -lssl -lcrypto -lssl -lcrypto -lz -lm	 -ldl -lm" CFLAGS="-I/home/aborle1/Baselibs/powerpc64le-unknown-linux-gnu/gfortran_5.4.0-openmpi_1.10.2/Linux/include" LDFLAGS="-L/home/aborle1/Baselibs/powerpc64le-unknown-linux-gnu/gfortran_5.4.0-openmpi_1.10.2/Linux/lib" ./configure --prefix=/home/aborle1/Baselibs/powerpc64le-unknown-linux-gnu/gfortran_5.4.0-openmpi_1.10.2/Linux $STATIC_BUILD $SHARED_BUILD
        LIBS="-ljpeg -lmfhdf -ldf -lhdf5_hl -lhdf5 -ldl -lm -L/home/aborle1/Baselibs/powerpc64le-unknown-linux-gnu/gfortran_5.4.0-openmpi_1.10.2/Linux/lib -lmfhdf -ldf -lsz -ljpeg  -L/home/aborle1/Baselibs/powerpc64le-unknown-linux-gnu/gfortran_5.4.0-openmpi_1.10.2/Linux/lib -lcurl -lssl -lcrypto -lssl -lcrypto -lz -lm	 -ldl -lm" make
        LIBS="-ljpeg -lmfhdf -ldf -lhdf5_hl -lhdf5 -ldl -lm -L/home/aborle1/Baselibs/powerpc64le-unknown-linux-gnu/gfortran_5.4.0-openmpi_1.10.2/Linux/lib -lmfhdf -ldf -lsz -ljpeg  -L/home/aborle1/Baselibs/powerpc64le-unknown-linux-gnu/gfortran_5.4.0-openmpi_1.10.2/Linux/lib -lcurl -lssl -lcrypto -lssl -lcrypto -lz -lm	 -ldl -lm" make check
    fi
