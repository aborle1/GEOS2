...
-----------------------------------------------------------------------------*/
static herr_t
HE5_ZAdefinefield(hid_t zaID, char *datafield, const char *za_name, char *dimlist, char *maxdimlist, hid_t numbertype)
{
  herr_t          status      = FAIL; /* Return status variable             */
...
-----------------------------------------------------------------------------*/
herr_t   
HE5_ZAwriteattr(hid_t zaID, const char *attrname, hid_t numbertype, hsize_t count[], void *datbuf)
{
  herr_t     status     = FAIL;          /* Return status variable  */
...
-----------------------------------------------------------------------------*/
herr_t   
HE5_ZAsetfillvalue(hid_t zaID, char *fieldname, hid_t numbertype, void *fillval)
{
  herr_t          status       = FAIL;/* return status variable       */
...
-----------------------------------------------------------------------------*/
herr_t    
HE5_ZAwritegrpattr(hid_t zaID, const char *attrname, hid_t numbertype, hsize_t  count[], void *datbuf)
{
  herr_t     status          = FAIL;     /* Return status variable */
...
-----------------------------------------------------------------------------*/
herr_t    
HE5_ZAwritelocattr(hid_t zaID, const char *fieldname, const char *attrname, hid_t numbertype, hsize_t  count[], void *datbuf)
{
  herr_t     status          =  FAIL;    /* Return status variable */
...
HE5_ZAwrattr(int ZaID, char *attrname, int numtype, long fortcount[], void * datbuf)
{
  ...
  if(numbertype == FAIL)
    {
      H5Epush(__FILE__, "HE5_ZAwrattr", __LINE__, H5E_DATATYPE, H5E_NOTFOUND, "Error calling HE5_EHconvdatatype() from FORTRAN wrapper.");
  ...
  if(numbertype == FAIL)
    {
      ...
      H5Epush(__FILE__, "HE5_ZAsetfill", __LINE__, H5E_DATATYPE, H5E_NOTFOUND, errbuf);
      HE5_EHprint(errbuf, __FILE__, __LINE__);
      return(FAIL);
    }
  ...
  if(numbertype == FAIL)
    {
      ...
      H5Epush(__FILE__, "HE5_ZAwrlattr", __LINE__, H5E_FUNC, H5E_CANTINIT, errbuf);
      HE5_EHprint(errbuf, __FILE__, __LINE__);
      return(FAIL);
    }
  ...
  if(numbertype == FAIL)
    {
      ...
      H5Epush(__FILE__, "HE5_ZAwrgattr", __LINE__, H5E_FUNC, H5E_CANTINIT, errbuf);
      HE5_EHprint(errbuf, __FILE__, __LINE__);
      free(errbuf);
      return(FAIL);
    }
...
HE5_ZAwrdmeta(int ZaID, char *fieldname, char *fortdimlist, int mvalue)
{
  ...
  if(numbertype == FAIL)
    {
      H5Epush(__FILE__, "HE5_ZAwrdmeta", __LINE__, H5E_DATATYPE, H5E_NOTFOUND, "Cannot convert datatype for FORTRAN wrapper.");
      HE5_EHprint("Error: Cannot convert datatype for FORTRAN wrapper, occured", __FILE__, __LINE__);
      return(FAIL);
    }
...
FCALLSCFUN8(INT, HE5_ZAidtype, HE5_ZAIDTYPEF, he5_zaidtype, INT,STRING,STRING,INT,PINT,PINT,PINT,PLONG)
