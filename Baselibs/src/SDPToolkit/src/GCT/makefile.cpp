...
#
#
# author:  Mike Sucher / G Bland / Megan E.D.Spencer
#
# history:
...
#	02-Feb-1995 ANS Adopted for GCT
#
...
#
# 	3) Variable SUBGROUPS must be set for each subgroup to be built.
#
#----------------------------------------------------------------------------
...
#
LIBOFILES      =  \
	$(PGSCPPO)/$(GRP)/PGS_GCT_Init.o \
	$(PGSCPPO)/$(GRP)/PGS_GCT_Proj.o 
...
$(PGSCPPO)/$(GRP)/PGS_GCT_Init.o: PGS_GCT_Init.c
	$(CPP) -c $(CPPFHFLAGS) $(DFLAGS) $(IFLAG) $? -o $@

$(PGSCPPO)/$(GRP)/PGS_GCT_Proj.o: PGS_GCT_Proj.c
	$(CPP) -c $(CPPFHFLAGS) $(DFLAGS) $(IFLAG) $? -o $@
