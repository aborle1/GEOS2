...
DEVICE, DECOMPOSED = 0
load_colors
colors = [41,40,20,21,22,23,24,25,26,27]
...
for month = 1,12 do begin
    for day =1,m_days[month -1] do begin
       ...
       contour,alpha,levels,h,levels=levels,color=255,/overplot,c_label=levels
       xyouts,levels[0],1.1, string(lwval,'(f5.2)'),orientation=90,color=0
       xyouts,levels[n_levels -1],1.1, string(upval,'(f5.2)'),orientation=90,color=0
...
!P.position=[0.33, 0.005, 0.67, 0.025]
