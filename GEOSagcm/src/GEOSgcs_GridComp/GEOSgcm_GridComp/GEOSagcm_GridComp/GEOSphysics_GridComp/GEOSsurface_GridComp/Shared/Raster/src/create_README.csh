...
\\n \
       ...
       classes (Table 2).  A global array of fractional coverage of each of the 17 classes\\n \
       on a 1152x768 grid, as used by CLM4 was obtained from UCAR.\\n \
\\n \
       ...
       mapping was based on the relative fractions found in the original 1152x768 CLM4 gridded\\n \
...
\\n \
       ...
       daylight trigger) and one that is not. Both sub-types are subject to moisture stress triggers\\n \
...
if( $MYMASK == GEOS5_10arcsec_mask | $MYMASK == GEOS5_10arcsec_mask.nc ) then
else
...
if( $MYMASK == GEOS5_10arcsec_mask  | $MYMASK == GEOS5_10arcsec_mask.nc) set pfaf_des=`echo "${pfafin_des}"`
...
3. VEGETATION CLASSIFICATION DATA ................................................. 3
   ...
   3.2 Data files and images
	...
	3.2.2 CLM and CLM-carbon vegetation types and fractions 
   3.3 References
...
3. VEGETATION CLASSIFICATION DATA
   ...
   3.2 Data files and images
	 ...
	 do n = 1, ${NTILES}
		...
		secondary_veg_frac, canopy_height
	 end do
...
cat << _EOV2_ > clsm/veg2
	...
	Water                                                    17          -
       ...
       3.2.3 Nitrogen Deposition, annual mean 2m Tair, soil back gorund albedo
...
_EOF0_
if( $MYMASK == GEOS5_10arcsec_mask.nc | $MYMASK == GEOS5_10arcsec_mask ) then
