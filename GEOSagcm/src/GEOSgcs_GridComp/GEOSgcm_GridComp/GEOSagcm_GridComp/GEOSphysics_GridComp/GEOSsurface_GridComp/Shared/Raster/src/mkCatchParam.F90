...
!     -l: Choice of LAI data set. DEFAULT : MODIS
...
!     -s: Choice of soil data. DEFAULT :NGDC                                                       
...
! Email: sarith.p.mahanama@nasa.gov
  ...
  implicit none
    ...
    real*8               :: dx, dy, lon0
    logical :: regrid
    character(len=400), dimension (19) ::  Usage 
    character*128        ::  Grid2
    character*2 :: poles
...
!   call system('cd ..')
    ...
    USAGE(7) ="         MODGEO  : MODIS with GEOLAND2 overlaid on South America, Africa and Australia            "
    USAGE(8) ="         GEOLAND2: 10-day climatology from the period 1999-2011 on 40320x20160 grid               "
    USAGE(9) ="         GSWP2   : Monthly climatology from the period 1982-1998 on 360x180 grid                  "
    USAGE(10)="         GSWPH   : Monthly climatology from the period 1982-1998 on 43200x21600 grid              "
    USAGE(11)="         MODIS   : 8-day climatology from the period 2000-2013  on 43200x21600 grid               "
    USAGE(12)="     -s: Choice of soil data. DEFAULT :HWSD                                                       "
    USAGE(13)="         HWSD : Merged HWSD-STATSGO2 soil properties on 43200x21600 with Woesten (1999) Parameters"
    USAGE(14)="         NGDC : Reynolds soil texture classes on 4320x2160 with GSWP2  soil hydraulic parameters  "
    USAGE(15)="     -m: Choice of MODIS Albedo data. DEFAULT : MODIS2                                            "
    USAGE(16)="         MODIS1: 16-day Climatology from 1'x1'(21600x10800) MODIS data from the period 2000-2004  "
    USAGE(17)="         MODIS2: 8-day Climatology from 0.5'x0.5'(43200x21600) MODIS data from the period 2001-2011"
    USAGE(18)="     -e: EASE : This is optional if catchment.def file is available already or                    "          
    USAGE(19)="                    the til file format is pre-Fortuna-2.                                         "           
...
!  
    ...
    if(SD=='NGDC') write (log_file,'(a)')'Done creating NGDC soil types file .......................4a'	   
    ...
    write (log_file,'(a,a,a)')'Done computing ',trim(SD),' soil parameters .......................4'
    ...
    write (log_file,'(a,a,a)')'Done computing ', trim(LD),' vegetation climatologies ............5'
    ...
    write (log_file,'(a,a,a)')'Done putting ',trim(MA), ' Albedo on the tile space  .............6'
    ...
    write (log_file,'(a,a,a)')'Done computing ',trim(MA), ' scale factors .......................7'
