...
#     include "../GMIchem_GridComp/GMI_GridComp/GmiShared/GmiInclude/gmi_phys_constants.h"
#     include "../GMIchem_GridComp/GMI_GridComp/GmiShared/GmiInclude/gmi_emiss_constants.h"
#     include "../GMIchem_GridComp/GMI_GridComp/GmiShared/GmiInclude/gmi_time_constants.h"
...
!     ----------------------
      ...
      real*8 ,                 intent(inout), OPTIONAL :: dry_depos (i1:i2, ju1:j2, 1:num_species)  !  optional
      type (t_GmiArrayBundle), intent(inout), OPTIONAL :: concentration(num_species)                !  optional
...
!     ==========
        ...
        if (PRESENT(dry_depos)) dry_depos(i1:i2,ju1:j2,1:num_species) = 0.0d0
...
#     include "../GMIchem_GridComp/GMI_GridComp/GmiShared/GmiInclude/gmi_phys_constants.h"
#     include "../GMIchem_GridComp/GMI_GridComp/GmiShared/GmiInclude/gmi_emiss_constants.h"
#     include "../GMIchem_GridComp/GMI_GridComp/GmiShared/GmiInclude/gmi_drydep_data.h"
