...
!BOP
!
! !IROUTINE:  SS_GridCompRun --- Run SS_GridComp
!
! !INTERFACE:
!
...
!-------------------------------------------------------------------------
   ...
   character(len=*), parameter :: myname = 'SS_GridCompRun1_'
   character(len=*), parameter :: Iam = myname
   integer :: ier(32), idiag
   integer :: i1, i2, im, j1, j2, jm, nbins, n1, n2, km, n, ios, ijl, ijkl, ijk1l, i, j
   real :: qmin, qmax
