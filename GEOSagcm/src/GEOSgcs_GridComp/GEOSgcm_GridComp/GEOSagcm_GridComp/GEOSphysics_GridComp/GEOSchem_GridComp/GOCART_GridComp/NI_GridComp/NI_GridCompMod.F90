...
!BOP
!
! !IROUTINE:  NI_GridCompRun --- Run NI_GridComp
!
! !INTERFACE:
!

   subroutine NI_GridCompRun ( gcNI, w_c, impChem, expChem, &
                                      nymd, nhms, cdt, rc )
...
!BOP
!
! !IROUTINE:  NI_GridCompRun --- The Chem Driver 
!
! !INTERFACE:
!
...
!-------------------------------------------------------------------------
   ...
   character(len=*), parameter :: myname = 'NI_GridCompRun'
   character(len=*), parameter :: Iam = myname

   integer :: ier(36), idiag
...
!  ----------------------
   if(associated(NH3_mass%data3d)) nh3_mass%data3d = gcNI%xhno3
...
!  ------------------------------------------------------------------
   call NI_Compute_Diags(i1, i2, j1, j2, km, nbins, gcNI, w_c, tmpu, rhoa, u, v, &
                         NH3_sfcmass, NH3_colmass, NH3_conc, &
                         NH4_sfcmass, NH4_colmass, NH4_conc, &
...
!
   ...
   subroutine NI_Compute_Diags ( i1, i2, j1, j2, km, nbins, gcNI, w_c, tmpu, rhoa, u, v, &
                                 NH3sfcmass, NH3colmass, NH3conc, &
                                 NH4sfcmass, NH4colmass, NH4conc, &
