...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            TOTAL_WATER =  (QIW_AN_dev(I,K)+QLW_AN_dev(I,K) + QIW_LS_dev(I,K)+ QIW_LS_dev(I,K))*MASS +QLWDTR_dev(I,K)*DT
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   subroutine fix_up_clouds_2M( &
      ...
      real, parameter :: nmin  = 1.0e-3
      real, parameter :: RL_cub  = 1.0e-15
      real, parameter :: RI_cub  = 6.4e-14
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   subroutine update_cld( &
      ...
      real :: QX, QSLIQ, QSICE, CFALL, DQx, FQA
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   subroutine PRECIP3(  &
      ...
      real :: TAU_FRZ, TAU_MLT, QSICE, DQSI, Told, QKCLR
...
!!! INITIALIZE DIAGNOSTIC ARRAYS !!!!!!!!!!!!!!!!!!!!!
      ...
      ELSE 
         ...
         do itr = 1,20 !only one iteration. 
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!Instantaneous freezing of condensate!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   subroutine cloud_ptr_stubs (             &
         ...
         CLDREFFI, CLDREFFL, NHET_IMM, NHET_DEP, NHET_DHF, &
         DUST_IMM, DUST_DEP, DUST_DHF, SCF, SCF_ALL, &           
         SIGW_GW, SIGW_CNV, SIGW_TURB, SIGW_RC, RHCmicro, DNHET_IMM, NONDUST_IMM, NONDUST_DEP, & 
      ...
      real  ,  pointer , dimension(:,:,:)  :: SMAXL,SMAXI, WSUB, CCN01, CCN04, CCN1, &
            ...
            NONDUST_IMM, NONDUST_DEP, BERG, BERGSO, MELT, DNHET_CT,  &
