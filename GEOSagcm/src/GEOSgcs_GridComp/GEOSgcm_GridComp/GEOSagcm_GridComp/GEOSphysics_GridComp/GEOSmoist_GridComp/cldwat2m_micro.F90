...
contains
   ...
   subroutine mmicro_pcond (                   &
         ...
         ts_auto_ice, ktrop_min, rflx, sflx &
#endif
      )
      ...
      real(r8), intent (in) :: miu_disp , ui_scale, dcrit, ts_auto_ice ! miu value in Liu autoconversion. Ui scale is used to tune olrcf by decreasing uised  
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
               ...
               if (t(i,k).le.273.15_r8.and.qiic(i,k).ge.qsmall) then
                  ...
                  if (.false.) then !Assume exponential 
                     ...
                     prci(k) = (qiic(i, k)/ts_auto_ice)*(1._r8-gamma_incomp(miu_ice+3._r8, lami(k)*dcs)) 
...
10             continue
         ...
         FUNCTION MUI_HEMP_L(lambda_)
            ...
            MUI_HEMP_L=max(min(mui, 10.0_r8), 0.1_r8)
