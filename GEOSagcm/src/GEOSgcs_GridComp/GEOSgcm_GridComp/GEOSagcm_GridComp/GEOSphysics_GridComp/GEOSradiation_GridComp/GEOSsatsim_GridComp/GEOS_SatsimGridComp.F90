...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    integer :: Npoints 
    real, dimension(IM*JM,NCOLUMNS,LM),target :: frac_out
    real, dimension(IM*JM,NCOLUMNS,LM),target :: frac_outinv
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      real, dimension(IM*JM,NCOLUMNS,LM ) :: lidar_beta_tot,lidar_tau_tot
...
! suffixes indicate the cosp return structures that the variables are copied out of
    real,    dimension(IM*JM,NCOLUMNS,LM) :: radar_ze_tot
    real,    dimension(IM*JM,NCOLUMNS,LM) :: radar_ze_tot_tmp
    logical, dimension(IM*JM,NCOLUMNS,LM) :: radar_ze_tot_mask
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   Npoints_it=NPOINTS         ! Number of gridpoints processed in one iteration (probably not used)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call construct_cosp_isccp(cfg,Npoints,Ncolumns,LM,isccp)
  call construct_cosp_sghydro(Npoints,Ncolumns,LM,N_hydro,sghydro)
  call construct_cosp_sgradar(cfg,Npoints,Ncolumns,LM,N_hydro,sgradar)
  call construct_cosp_sglidar(cfg,Npoints,Ncolumns,LM,N_hydro,PARASOL_NREFL,sglidar)
...
! a different grid from the model.  So mostly dummy params get passed`
  ...
  call construct_cosp_radarstats(cfg,Npoints,Ncolumns,LM,N_hydro,stradar)
  call construct_cosp_lidarstats(cfg,Npoints,Ncolumns,LM,N_hydro,PARASOL_NREFL,stlidar)
...
if ( MAPL_Am_I_Root() .and. DEBUG_GC ) then
  ...
  write(115) ncolumns,lm
  
  write(115) FCLD

  write(115) gbx%dtau_s
  write(115) gbx%dem_s

  write(115) gbx%tca
  write(115) sgx%frac_out
