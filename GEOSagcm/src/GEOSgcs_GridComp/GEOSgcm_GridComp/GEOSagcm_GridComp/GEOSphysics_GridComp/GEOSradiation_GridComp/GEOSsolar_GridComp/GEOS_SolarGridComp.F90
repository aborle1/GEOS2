...
!----------------------------
    ...
    if (USE_CHOU) then
       NUM_SW_BANDS = NB_CHOU
    else
       NUM_SW_BANDS = NB_RRTMG
    end if
...
! Local variables
    ...
    real    :: PRS_LOW_MID
    real    :: PRS_MID_HIGH
    real    :: SC, HK(8), HK_IR_TEMP(3,10), HK_UV_TEMP(5)
    integer :: SUNFLAG
    ...
    real, save :: CO2_0, SC_0
    data          CO2_0 /0.0/, SC_0/0.0/
...
! Adjustment for Earth/Sun distance, but currently not using. 
      ADJES  = 1.
