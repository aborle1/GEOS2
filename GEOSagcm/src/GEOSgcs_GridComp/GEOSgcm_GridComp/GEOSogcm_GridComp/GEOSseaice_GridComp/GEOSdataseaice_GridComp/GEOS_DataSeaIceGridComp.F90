...
! !MODULE: GEOS_DataSeaIce -- A `fake' seaice model
...
!   ocean\_bcs file 
!   This module interpolates the SST and sea ice fraction data from 
...
! !Import state:
  ...
  if (DO_CICE_THERMO /= 0) then
     ...
     call MAPL_AddImportSpec(GC,                                      &
          SHORT_NAME         = 'UWB',                               &
          LONG_NAME          = 'water_skin_eastward_velocity_on_b_grid',      &
          UNITS              = 'm s-1 ',                            &
          DIMS               = MAPL_DimsHorzOnly,                   &
          VLOCATION          = MAPL_VLocationNone,                  &
          RC=STATUS  )
     ...
     call MAPL_AddImportSpec(GC,                                      &
          SHORT_NAME         = 'VWB',                               &
          LONG_NAME          = 'water_skin_northward_velocity_on_b_grid',&
          UNITS              = 'm s-1 ',                            &
          DIMS               = MAPL_DimsHorzOnly,                   &
          VLOCATION          = MAPL_VLocationNone,                  &
          RC=STATUS  )
