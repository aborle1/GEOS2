...
! !DESCRIPTION:
!
! Read an unformatted file and scatter to processors.  \! work is a real array, atype indicates the format of the data.
...
! !DESCRIPTION:
!
! Read a netCDF file and scatter to processors. \! If the optional variables field_loc and field_type are present,
! the ghost cells are filled using values from the global array.
! This prevents them from being filled with zeroes in land cells
! (subroutine ice_HaloUpdate need not be called).
!
