...
! temperature and humidity. NOTE: \! (1) all fluxes are positive downward,  \! (2) here, tstar = (WT)/U*, and qstar = (WQ)/U*,  \! (3) wind speeds should all be above a minimum speed (eg. 1.0 m/s). \!
! ASSUME:
