...
'set dfile 'ddif.m
'set t 'tbeg.m' 'tdif.m
'makezdif3 -q1   rUp'm' -file1 'mfile' -q2  zero  -file2 1  -ptop 100 -name  rUp'
...
'set csmooth on'
'shades 'cint
'd maskout( ravediff*1000, abs(ravediff)-rUpdiff )'
'cbarn -xmid 6'
...
'set  strsiz .132'
'draw string 6.0 8.15 'expdsc.m'(dash) - 'expdsc.0'(dot) ('numfiles')   'region
